...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TableSortLabel, Avatar, Box, Typography, createTheme, ThemeProvider, styled } from '@mui/material';
            ...
            <ThemeProvider theme={darkTheme}>
                <TableContainer component={Paper} sx={{ overflowX: "" }}>
                    <Table stickyHeader aria-label="sticky table">
                        <TableHead>
                            <TableRow>
                                {['Asset', 'Bestand', 'X', 'Preis /+-%', 'DCA Preis', 'Investition', 'Relevanz', 'DCA', 'Gewichtung'].map((headCell) => (
                                    <TableCell
                                        key={headCell}
                                    ...
                                    <TableRow key={index} sx={{
                                        ...
                                        <TableCell component="th" scope="row" sx={{ padding: "0px" }}>
                                            <Box sx={{
                                                ...
                                                <CategoryColorBar color={getCategoryColor(row.category)} />
                                                <Box display="flex" alignItems="center">
                                                    <Avatar alt={row.asset} src={row.imageUrl} sx={{ width: 24, height: 24, marginRight: 1 }} />
                                                    <Typography>
                                        ...
                                        <TableCell component="th" scope="row" sx={{ padding: "5px" }}>
                                            <Box sx={{ display: "flex", flexDirection: "column", alignItems: "end" }}>
                                                <StyledTypography>{row.bestand}</StyledTypography>
                                                <StyledTypography sx={{ color: "#999" }}>{row.totalCoins} {row.ticker}</StyledTypography>
                                            </Box>
                                        </TableCell>
                                        ...
                                        <TableCell sx={{ padding: "5px" }}>
                                            <StyledTypography sx={{ alignItems: "center" }}>{row.gewichtung}</StyledTypography>
                                        </TableCell>
                                    </TableRow>
                                ))}
                        </TableBody>
