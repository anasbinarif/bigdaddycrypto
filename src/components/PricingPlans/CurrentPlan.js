                ...
                {planDetails ? (
                    <>
                        <Typography variant="h4" gutterBottom>
                            Your Current Plan: <span style={{ color: "#4caf50" }}>{planDetails.plan}</span>
                        </Typography>
                        <Typography variant="h6" gutterBottom>
                            Billing Cycle: <span style={{ color: "#fbc02d" }}>{planDetails.billingCycle}</span>
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                            Status: <span style={{ color: planDetails.status === "active" ? "#4caf50" : "#f44336" }}>{planDetails.status}</span>
                        </Typography>
                        <Typography variant="body2" gutterBottom>
                            Next Billed At: <span style={{ fontWeight: "bold" }}>{formatNextBilledAt()}</span>
                        </Typography>
                    </>
                ) : (
                    <>
