...
import {
  bewerteAssetExtremPessimistisch, bewerteAssetSpaeteinsteiger,
  categoryColorsNew,
  getUserPortfolio,
...
const CoinCard = ({ coin, selected, search = false, risk, priceIndicator }) => {
  const { Name, cgImageURL, Ticker, Potential, Sicherheit, Category, BottomRanking,
    Bottom,
    Price } = coin;
