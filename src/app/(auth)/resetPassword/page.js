...
const ResetPasswordPage = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                setAlert({ open: true, message: "Password reset successfully.", severity: "success" });
                router.push("/login");
            } else {
                setAlert({ open: true, message: result.error || "Failed to reset password.", severity: "error" });
            }
        } catch (error) {
            ...
            >
                ...
                >
                    ...
                    <TextField
                        ...
                        helperText={errors.confirmNewPassword ? errors.confirmNewPasswordMessage : ""}
                    />
