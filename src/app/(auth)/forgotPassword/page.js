...
const ForgotPasswordPage = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                setAlert({ open: true, message: "Reset link sent to your email.", severity: "success" });
            } else {
                setAlert({ open: true, message: result.error || "Failed to send reset link.", severity: "error" });
            }
        } catch (error) {
