    ...
    const handleSubmit = async (event) => {
        ...
        const formattedData = {
            ...
            categories: formData.categories.map((category) => {
                return Object.keys(categoriesDisplay1).find(key => categoriesDisplay1[key] === category);
            })
        };
            ...
            >
                ...
                >
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        {formData.cgImageURL && <Avatar src={formData.cgImageURL} sx={{ width: 50, height: 50 }} />}
                    </Box>
