...
function MarketLowLineChart({ data }) {
  ChartJS.register(
    Tooltip,
    Legend,
    ArcElement,
  ...
  let lineData = {
    datasets: processMarketLowLineChart(data, backgroundColor, borderColor),
  };
...
const processMarketLowLineChart = (data, backgroundColor, borderColor) => {
  ...
  filteredData.forEach((d, i) => {
    dataset.push({
      ...
      data: [
        {
          x: "MC at Lowest Low Before",
          y: parseFloat(d["MC at Lowest Low Before"]),
        },
        {
...
export default MarketLowLineChart;
