...
function RankTopLowLineChart({ data }) {
  ChartJS.register(
    Tooltip,
    Legend,
    ArcElement,
  ...
  let lineData = {
    datasets: processRankTopLowLineChart(data, backgroundColor, borderColor),
  };
...
const processRankTopLowLineChart = (data, backgroundColor, borderColor) => {
    ...
    dataset.push({
      ...
      data: [
        ...
        },
        {
          ...
          y: parseFloat(d["Rank Lowest Low After"]),
        },
      ],
    });
  });
...
export default RankTopLowLineChart;
