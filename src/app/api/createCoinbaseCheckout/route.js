    ...
    try {
        const response = await fetch('https://api.commerce.coinbase.com/charges', {
            ...
            body: JSON.stringify({
                ...
                redirects: {
                    cancel_url: `${process.env.NEXT_PUBLIC_URI}/pricingPlans`,  // Update with your actual cancel URL
                    success_url: 'https://yourdomain.com/success',  // Update with your actual success URL
                },
            }),
        });
